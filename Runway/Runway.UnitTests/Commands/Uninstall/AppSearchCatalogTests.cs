...
{
   public class AppSearchCatalogTests
   {
      [Fact]
      public void Find_CatalogIsEmpty_ReturnsNoResults()
      {
         ...
         var appCatalog = new AppSearchCatalog( registryMock.Object, null );

         var results = appCatalog.Search( "notepad" );
      ...
      public void Find_SearchesForAppByName_FindsApp()
      {
         ...
         var results = appCatalog.Search( appName );

         // Assert

         results.Should().HaveCount( 1 );
         results[0].DisplayText.Should().Be( appName );
      ...
      public void Find_HasOneAppAndSearchesForSomethingElse_ReturnsAnEmptySet()
      {
         ...
         var results = appCatalog.Search( "doesnotexist" );
      ...
      public void Find_HasTwoAppsAndSearchesWithPartialText_ReturnsBoth()
      {
         ...
         var results = appCatalog.Search( "n" );
      ...
      public void Uninstall_PassesAppPath_StartsCorrespondingUninstallString()
      {
         ...
         var appCatalog = new AppSearchCatalog( registryMock.Object, processMock.Object );
